...
#PARAM$semillas <- c(100019, 100043, 100049, 100057, 100069) CUANDO ERAN 5 SEMILLAS
#A CONTINUACIÓN LAS 20 SEMILLAS 
PARAM$semillas <- c(100019, 100043, 100049, 100057, 100069, 600169, 600217, 600241, 600317, 600323, 600361, 600367, 600427, 600449, 600463, 600571, 600607, 600641, 600649, 600673) 
#------------------------------------------------------------------------------
