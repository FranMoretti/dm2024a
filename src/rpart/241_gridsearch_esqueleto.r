...
archivo_salida <- "./exp/HT2020/gridsearch4.txt"
...
for (vmax_depth in c(6)) {
  for (vmin_split in c(800, 600, 400)) {
    for (vcp in c(-0.5)) {
      for(vmin_bucket in c(vmin_split, vmin_split/5, vmin_split/4, vmin_split/3, vmin_split/2, vmin_split/1.5)) {
        param_basicos <- list(
